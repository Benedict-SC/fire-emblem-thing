Unit = function(unitdata)
    ...
    unit.maxhpGrowth = unitdata.mhpg or 90--50;
    unit.strGrowth = unitdata.strg or 90--30;
    unit.sklGrowth = unitdata.sklg or 90--40;
    unit.lukGrowth = unitdata.lukg or 90--20;
    unit.spdGrowth = unitdata.spdg or 90--30;
    unit.defGrowth = unitdata.defg or 90--30;
    unit.resGrowth = unitdata.resg or 90--20;
    unit.exp = 0;
